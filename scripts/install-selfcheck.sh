...
echo "       7. 一键全链路验收:        $REPO_ROOT/tests/test_full_acceptance.py"
echo "       8. 原生 session demo:    $REPO_ROOT/scripts/runtime_sessions.py \"/mac 搜索 GitHub 最近 7 天 star 涨得最快的 10 个项目，总结特点\""
echo "       9. 查看命令文档:         cat $REPO_ROOT/docs/guides/openclaw-agent-session-commands.md"
echo "      10. 查看 skill 参考:       cat "$SHARED_SKILL_DIR/SKILL.md" && ls "$SHARED_SKILL_DIR/references""
