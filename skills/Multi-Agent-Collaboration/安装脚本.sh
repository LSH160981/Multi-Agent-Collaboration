...
TARGET_MAC_BRIDGE_DIR="$TARGET_SKILLS_DIR/mac"
...
echo "已安装 /mac 命令桥：$TARGET_MAC_BRIDGE_DIR"
echo "建议下一步："
echo "1. 新开一个 OpenClaw session 或刷新 skills"
echo "2. 阅读 $TARGET_SKILL_DIR/安装与使用.md"
echo "3. 查看 docs/openclaw-agent-session-commands.md"
echo "4. 按 测试脚本.md 执行握手测试和静默任务测试"
